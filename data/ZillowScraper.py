# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 15:49:10 2022
...
city = '/richfield-mn' #*****change this city to what you want!!!!*****
...
data_list = [data1,data2,data3,data4,data5,data6,data7,data8,data9,data10] # ,data11,data12,data13,data14,data15,data16,data17,data18,data19,data20]
...
# print(df.head())
#print(df.columns)
home_info_list = list(df['hdpData'])
df1 = pd.DataFrame(home_info_list)
import os
print(os.getcwd())
#%%%

# print(home_info_list[0]['homeInfo'].keys())
# 'homeInfo'
home_info_list_unnested = [home['homeInfo'] for home in home_info_list]

df_final = pd.DataFrame(home_info_list_unnested)
os.chdir(r'C:\Users\salaz\OneDrive\Desktop\Projects\Zillow')
print(os.getcwd())
df_final.to_csv('richfield_final.csv')
